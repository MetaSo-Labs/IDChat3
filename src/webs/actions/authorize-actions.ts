...
//DOGE
import * as DogeInscribe from './lib/authorize/doge/inscribe';
...
export default {
  ...
  Inscribe: {
    ...
    nextComponent: lazy(() => import('../components/InscribeMetaPin/Estimator')),
  },
  DogeInscribe: {
    name: 'DogeInscribe',
    title: 'Doge Inscribe',
   ...
   CreatePin: {
    name: 'CreatePin',
    title: 'Create PIN',
    descriptions: ['Create MetaID PIN on blockchain'],
    estimate: doNothing,
