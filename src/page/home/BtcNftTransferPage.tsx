...
export default function BtcNftTransferPage({ route }) {
  const {type, nftDetail } = route.params;
  ...
  async function sendBRC20() {
    ...
    const { fee, rawTx: _rawTx } = metaletWallet.currentBtcWallet!.signTx(SignType.Transfer, {
        ...
        <View style={{ padding: 20 }}>
          ...
          >
            ...
            >
              ...
              <View style={{ flex: 1 }} />
              <Text style={{ color: "#999", fontSize: 14 }}>{feed} sat/vB</Text>
              <Image
