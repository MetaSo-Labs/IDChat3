...
export default function AssetsPage() {
  ...
  useEffect(() => {
    // console.log("AssetsPage useEffect called");
        ...
        {netWork == network_btc && (
          ...
          >
            ...
            >
              ...
              <View>
                <Text
                  style={{ color: "#333", fontSize: 16, textAlign: "right" }}
                >
                  {btcBalance} BTC{" "}
                </Text>
                <Text
          ...
          >
            <View style={{ backgroundColor: "#fff", padding: 3 }}>
              ...
              >
                ...
                <Text style={{ fontSize: 10, color: "#999999", marginLeft: 3 }}>
                  BTC
                </Text>
